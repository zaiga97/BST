...
template<typename Tkey, typename Tvalue, typename Tcompare>
template <typename Tpair_i>
BST<Tkey, Tvalue, Tcompare>::_iterator<Tpair_i> BST<Tkey, Tvalue, Tcompare>::_iterator<Tpair_i>::operator++(int){
	// copy in temp
	auto tmp{*this};
	// pre increment
	++(*this);
...
template<typename Tkey, typename Tvalue, typename Tcompare>
template <typename Tpair_i>
BST<Tkey, Tvalue, Tcompare>::_iterator<Tpair_i> BST<Tkey, Tvalue, Tcompare>::_iterator<Tpair_i>::operator+(int n){
